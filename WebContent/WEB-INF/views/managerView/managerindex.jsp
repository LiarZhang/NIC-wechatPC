...
<body style="background-color: #f2f9fd;">
	<div class="header bg-main">
		...
		<div class="head-l">
			<%-- <a class="button button-little bg-green" href="${pageContext.request.contextPath }/workManager/toUnFinish" target="_blank">
	...
	<div class="leftnav">
		...
		<ul style="display: block">
			<li><a
				href="${pageContext.request.contextPath }/shownews/toshownews"
				target="right"><span class="icon-caret-right"></span>发布消息</a></li>
			<li><a
				href="${pageContext.request.contextPath }/shownews/toshownewsList"
		...
		<ul style="display: block" id="show">
			<li><a href="${pageContext.request.contextPath }/manager/toload"
		...
		<h2>
			<span class="icon-user"></span>系部管理
		</h2>
		<ul style="display: block" id="show">
			<li><a
				href="${pageContext.request.contextPath }/departmentManager/todepartList"
				target="right"><span class="icon-caret-right"></span>系部管理</a></li>
		</ul>
		<h2>

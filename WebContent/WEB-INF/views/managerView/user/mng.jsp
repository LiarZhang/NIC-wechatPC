    ...
    <div class="col-md-12">
        <div class="portlet light portlet-fit bordered">
            <div class="portlet-title">
                <div class="row">
                   <div class="col-md-2">
                        <input id="userName" class="form-control" type="text" placeholder="用户名称"/>
                    </div>
                    <div class="col-md-2">
                        <input id="userDepartment" class="form-control" type="text" placeholder="部门"/>
                    </div>
                    <div class="col-md-2">
                     ...
                     <div class="col-md-2">
                        <input id="userNickname" class="form-control" type="text" placeholder="微信昵称"/>
                    </div>
                    <div class="col-md-2">
                        <input id="userTelephone" class="form-control" type="text" placeholder="手机号"/>
                    </div>
                    <div class="col-md-2 ">
...
<script src="${pageContext.request.contextPath }/js/user/mng.js"></script>
